...
abstract class $DiscountModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'desconto') double discount});
}
...
class _$DiscountModelImpl extends _DiscountModel {
  const _$DiscountModelImpl({@JsonKey(name: 'desconto') required this.discount})
      : super._();
  ...
  @override
  String toString() {
    return 'DiscountModel(discount: $discount)';
  }
...
abstract class _DiscountModel extends DiscountModel {
  const factory _DiscountModel(
          {@JsonKey(name: 'desconto') required final double discount}) =
      _$DiscountModelImpl;
